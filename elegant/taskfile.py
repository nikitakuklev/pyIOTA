...
class Task:
    def __init__(self, lattice: str = None, run_folder: str = None, auto_paths: bool = True,
        ...
        """
        Elegant taskfile generator. Allows to build up taskfiles with same syntax as regular elegant files.
        :param lattice:
    ...
    def _header(self):
        ...
        sl.append(f"!Module: {Task.__module__ + '.' + Task.__qualname__} v{pyIOTA.__version__}")
